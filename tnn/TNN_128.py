...
# Loading model
model = TNN_Classifier(X_h1_train,y_h1_train,3, num_layers_boosted = num_boosted, kind_layers=128)
...
# Loading model
model = TNN_Classifier(X_h2_train,y_h2_train,3, num_layers_boosted = num_boosted, kind_layers=128)
criterion = torch.nn.CrossEntropyLoss()
optimizer = torch.optim.Adam(model.parameters(), lr=lr)
# Start training
